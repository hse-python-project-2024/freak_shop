...
RuleTexts = [["                            Добро пожаловать в жуткую лавку!",
             ...
             ["                                Welcome to the Freak Shop!",
              "",
              "     The rules are simple: acquire in-game points for the tasks.",
              ...
              "",
              "  1 - Exchange any cards of the same value from your hand ",
              "          for as many cards of the other value from the Shop.",
              "",
              "                        2 - Exchange cards from your hand ",
              "          for cards from the Shop with the same value sum.",
              "",
